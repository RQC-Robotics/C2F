...
import sys
sys.path.append('/home/albert/C2FARM39/ARM')
...
def visualise(logdir, task, method, cfg):
    ...
    import arm.env_client as real_env
    
    env = real_env.EnvClient()
...
@hydra.main(config_name='config', config_path='/home/albert/C2FARM39/ARM/conf')
def main(cfg: DictConfig) -> None:
    print(OmegaConf.to_yaml(cfg))
    visualise('/path/to/log/dir', 'take_lid_off_saucepan', 'C2FARM', cfg)
