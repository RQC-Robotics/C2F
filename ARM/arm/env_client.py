...
import sys
sys.path.append('/home/albert/C2FARM39/ARM/arm')
...
class EnvClient(Env):
    def __init__(self,
        ...
        self._dataset_root = '/home/albert/C2FARM39/rubbish_demo' #sort_one_fig' #SortNew' #pick_santa'  #pick_up_kinect'
        # myDemoKinect'
    ...
    def step(self, action):
        ...
        print('STEP:  ', act)
        info = action.info.copy()
        res_info = {'voxel_grid_depth0': info['voxel_grid_depth0'].detach().cpu(),
                    'q_depth0' : info['q_depth0'].detach().cpu(),
                    'voxel_idx_depth0': info['voxel_idx_depth0'].detach().cpu()}
        return self.client.step((act, res_info))
    ...
    def extract_obs(self, obs, t=None, prev_action=None):
        ...
        ext_obs = {
                    ...
                    'gripper_pose': np.array(np.concatenate([TCP_quat, obs['gripper/pose']]), dtype=np.float32),
